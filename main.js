...
document.getElementById('saveTrackBtn').addEventListener('click', async () => {
    ...
    const holeId = document.getElementById('holeSelect').value;
    const currentMerchantId = 'JNG'; // Terkunci ke JNG sesuai permintaan
...
document.getElementById('newGameBtn').addEventListener('click', async () => {
    ...
    // LOGIKA PEMBERSIHAN: Jika user memasukkan 'JNG-gditb94-031026-1', kita ambil 'gditb94' saja
    ...
    if (confirmStart.isConfirmed) {
        // Gunakan fungsi buildRoundId yang sudah ada untuk merakit format JNG-gditb94-DDMMYY-X
...
// Tambahan fungsi untuk versi 2.1
...
// Fungsi untuk membuat Round ID sesuai aturan: JNG-gditb94-031026-1
function buildRoundId(groupName, roundNumber) {
    const fieldCode = "JNG"; // Bisa dinamis sesuai lapangan aktif tapi karena tiap lapangan
...
async function syncMultiplayer() {
    ...
    // Rakit ID format baru: JNG-gditb94-DDMMYY-1
